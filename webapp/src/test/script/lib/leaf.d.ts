declare namespace Leaf {
    ...
    type WidgetTemplate = string | HTMLElement | {
        (): string | HTMLElement;
    };
    ...
    type Callback<T = null, E extends Error = Error> = (error?: E, option?: T) => void;
}
declare namespace Leaf {
...
declare namespace Leaf {
    class Serializer {
        ...
        dataKey: string;
        typeMap: {
            [type: string]: Serializer.ConvertConfig;
        };
        private tokenize(data);
        private detokenize(v);
        serialize(data: any): string;
        deserialize(data: any): any;
        register(type: string, config: Serializer.ConvertConfig): void;
        static defaultSerializer: Serializer;
        static getDefault(): Serializer;
    }
    namespace Serializer {
        type Constructor<T = {}> = new (...args: any[]) => T;
        interface ConvertConfig<T = any, V = any> {
            Cons: Constructor<T>;
            fromType: (T) => V;
            toType: (V) => T;
        }
...
declare namespace Leaf {
    type EventEmitterHandler<T> = (data: T, ...args: any[]) => void;
    ...
    class EventEmitter<E = {
        ...
        readonly DECLARE: E;
        constructor();
        addEventListener<K extends keyof E>(event: K, handler: (data: E[K], ...args: any[]) => void): this;
        on<K extends keyof E>(event: keyof E, handler: (data: E[K], ...args: any[]) => void): this;
        once<K extends keyof E>(event: keyof E, handler: (data: E[K], ...args: any[]) => void): this;
        listenByOnce<K extends keyof E>(who: any, event: K, handler: (data: E[K], ...args: any[]) => void): this;
        listenBy<K extends keyof E>(who: any, event: K | K[], handler: (data: E[K], ...args: any[]) => void): this;
        stopListenBy<K extends keyof E>(who: any, event?: keyof E, handler?: (data: E[K], ...args: any[]) => void): this;
        removeEventListener<K extends keyof E>(event?: keyof E, handler?: (data: E[K], ...args: any[]) => void): this;
...
declare namespace Leaf {
    ...
    class States<TStateEnum extends string = string, TSignalEnum = {
        ...
        consumeAll(name: keyof TSignalEnum): number;
        hasFeed(name: keyof TSignalEnum): boolean;
        consume(name: keyof TSignalEnum): boolean | any;
...
declare namespace Leaf {
    class DataSource<TAttribute> {
        ...
        protected define(name: keyof TAttribute, defaultValue?: any): void;
    ...
    class DataTree<TAttribute = any> {
        readonly source: DataSource<TAttribute>;
        constructor(source: DataSource<TAttribute>);
        getNode(path?: string): DataNode<any>;
        valueCanBeObject(v: any): boolean;
        getValueByPath(path: string): any;
        setValueByPath(path: string, v: any): boolean;
    }
    class DataNode<T = any> {
        readonly tree: DataTree;
        readonly path: string;
        constructor(tree: DataTree, path?: string);
        getProxyOrValue(): any;
        set(v: T): boolean;
        get(): T;
        toString(): string;
...
declare namespace Leaf {
    ...
    abstract class WidgetCoreDesign {
        ...
        abstract attachText(text: Text, config: Leaf.DynamicStringConfig): any;
        abstract detachText(text: Text): any;
        abstract extractDynamicPropertyConfig(el: WidgetElement): DynamicProperties;
        abstract extractDynamicStringConfig(content: string): Leaf.DynamicStringConfig;
        ...
        abstract syncDynamicText(text: Text, rule: Leaf.DynamicStringConfig): any;
        abstract attachDynamicText(text: Text, rule: Leaf.DynamicStringConfig): any;
    ...
    abstract class WidgetInitializerDesign {
        ...
        abstract createText(rule: Leaf.DynamicStringConfig): any;
    }
    class WidgetCore extends WidgetCoreDesign {
        ...
        attachText(text: Text, config: Leaf.DynamicStringConfig): void;
        ...
        syncDynamicText(text: Text, rule: Leaf.DynamicStringConfig): void;
        ...
        attachDynamicText(text: Text, rule: Leaf.DynamicStringConfig): void;
        ...
        extractDynamicStringConfig(content: string): Leaf.DynamicStringConfig;
    ...
    class WidgetInitializer extends WidgetInitializerDesign {
        ...
        createText(rule: Leaf.DynamicStringConfig): Text;
    }
...
declare namespace Leaf {
    class Widget<TUIs extends {
        ...
        protected makeList<T extends ListItem>(who: (keyof TUIs) | HTMLElement): List<T>;
        behave(handler: THandlers): void;
    }
    abstract class GeneratedWidget<TUIs extends {
        ...
        protected _t(rule: Leaf.DynamicStringConfig): Text;
...
declare namespace Leaf {
    namespace CoreLogic {
        ...
        function explainDynamicString(model: DataTree<any>, config: Leaf.DynamicStringConfig): string;
        function explainDynamicValue(tree: DataTree<any>, config: DynamicValueConfig): any;
        function getPropertyRoot(str: string): string;
    }
}
declare namespace Leaf {
    namespace Key {
